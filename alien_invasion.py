...
class AlienInvasion:
	...
	def _check_events(self):
		...
		for event in pygame.event.get():
			if event.type == pygame.QUIT:
				...
				self._check_play_button_mouse(mouse_pos)

	def _check_play_button_mouse(self, mouse_pos):
	...
	def _update_bullets(self):
		...
		# Get rid of bulletsthat have disappeared
	...
	def _check_fleet_edges(self):
		""" Respond appropriately if any alien reaches an edge """
